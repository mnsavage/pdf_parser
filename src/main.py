        ...
        'header': [
            ...
            },
            {
                ...
                'requirements': [
                    ...
                    },
                    {
                        ...
                        'met': parser.check_no_empty_pages() or parser.check_font_not_same_throughout_pdf()
                    },
                    {
            ...
            },
            {
                ...
                'requirements': [
                    ...
                    {
                        'title': 'Dedication page: optional',
                        'met': None
                    },
                    {
                    ...
                    {
                        'title': 'References: All URLs must be in black ink',
                        'met': None
                    },
                    {
            ...
            },
            {
                ...
                'requirements': [
                    ...
                    {
                        'title': 'Begin with a 2" top margin',
                        'met': None
                    },
                    {
                        'title': 'Other: see comments',
